...
JGraph.prototype.findCircuits = function findCircuits(limit, F) {
  var startNode;
  var stack = [];
  var circuits = [];
  var blocked = new Map();
...
self.addEventListener('message', (e) => {
  var jg = new JGraph(e.data[0], e.data[1]);
  var ccc = jg.findCircuits(e.data[2], c => {
